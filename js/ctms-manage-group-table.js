...
layui.use(['layer','form','table'], function(){
  ...
  table.render({
    ...
    ,height: 315
    ,id:'testReload'
    ,url: Myport+'getGroupList' //数据接口，要改
    ...
    ,cols: [[ //表头，要改
      ...
      ,{field: 'group_no', title: '群号',templet: '#group_no',align:'center'}
      ,{field: 'group_name', title: '群名称',align:'center'}
      ,{field: 'group_des', title: '群描述',align:'center'}
      ,{field: 'group_loca', title: '安装位置',align:'center'}
      ,{field: 'serial_port', title: '监听串口号',align:'center'}
      ,{field: 'operate', title: '操作',toolbar: '#optbar',minWidth:150,align:'center'}
    ]]
  });
	//监听工具条
    ...
    var tr = obj.tr; //获得当前行 tr 的DOM对象
      ...
      layer.confirm('确定要删除此群吗？',{ title:'提示',shadeClose:true,btnAlign: 'c',btn:['取消', '确定']}
      ,function(index){// 取消
	      layer.close(index);
	    },function(index){// 确定
        layer.close(index);
