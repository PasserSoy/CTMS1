...
layui.use(['layer','form','table'], function(){
  ...
  table.render({
    ...
    ,height: 315
    ,id:'testReload'
    ,url: Myport+'getPointList' //数据接口，要改
    ...
    ,cols: [[ //表头，要改
      ...
      ,{field: 'point_no', title: '监测点号',align:'center'}
      ,{field: 'point_name', title: '监测点名称',align:'center'}
      ,{field: 'location', title: '性质',templet: '#location',align:'center'}
